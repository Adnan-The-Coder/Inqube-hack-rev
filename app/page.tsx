...
export default function SparklesPreview() {
  ...
  const [isLoading, setIsLoading] = useState(
    typeof window !== "undefined" && !sessionStorage.getItem("loadingDone")
  );
    ...
    return (
      <div className="relative flex h-screen items-center justify-center bg-black">
        ...
        <div className="relative z-10 flex w-full flex-col items-center px-6">
          <h2 className="mb-6 animate-pulse text-xl text-white">
            Loading, please wait...
          </h2>
          <div className="relative h-4 w-full max-w-lg overflow-hidden rounded-full bg-gray-700">
            ...
            >
              <Image
                src="https://img.icons8.com/?size=100&id=pYfkFiezZNdW&format=png&color=ffffff"
                alt="plane"
                width={20}
                height={20}
              />
  ...
  return (
    <div className="text-white">
      ...
      {isVisible && (
        <button
          onClick={scrollToTop}
          className="back-top fixed bottom-10 right-10 rounded-full bg-[#76b900] p-3 text-white shadow-lg"
