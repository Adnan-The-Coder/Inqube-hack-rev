    ...
    <div className="flex flex-col h-screen bg-[#121212] text-white">
      <header className="bg-[#181818] p-4 flex justify-between items-center shadow-md sticky top-0 z-50">
        ...
        >
          <ul className="flex flex-col lg:flex-row gap-4 p-4 lg:p-0 text-center lg:text-left">
            <li>
              <Link href="/" className="text-white hover:text-[#76b900] font-medium">
                Home
              </Link>
            </li>
            <li>
              <Link href="/about" className="text-white hover:text-[#76b900] font-medium">
                About
              </Link>
            </li>
            <li>
              <Link href="/marketplace" className="text-white hover:text-[#76b900] font-medium">
                Marketplace
              </Link>
            </li>
            <li>
              <Link href="/contact" className="text-white hover:text-[#76b900] font-medium">
                Contact
              </Link>
            </li>
          </ul>
      ...
      <div className="flex flex-1 overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto">
            {chats.map((chat) => (
              ...
              >
                ...
                {chat.unread && <div className="w-2 h-2 bg-[#76b900] rounded-full"></div>}
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto bg-[#181818] p-4 lg:p-6 xl:p-10">
          <div className="mb-8">
            <h1 className="text-2xl lg:text-4xl font-bold tracking-wide text-white">Developer Dashboard</h1>
            <p className="text-gray-400 mt-2">Welcome back! Here's an overview of your projects and stats.</p>
          </div>
